          ...
          <div className="relative mx-auto w-full max-w-7xl px-6 pb-24 pt-36 sm:pb-32 sm:pt-44 lg:px-8 lg:pb-40">
            <div className="max-w-4xl">
                <div className="mb-8 flex items-center gap-4">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-[0.28em] text-blue-deep/70">
                    Connect
                  </span>
                </div>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
            <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:gap-24">
              ...
              <div>
                  ...
                  <h2 className="mt-6 max-w-md text-4xl text-bronze font-semibold leading-[0.95] tracking-[-0.04em] sm:text-3xl">
                    Connect with Pastor Olawale Smith on all media networks.
                  </h2>
                  ...
                  return (
                    <Reveal key={network.name} delay={0.08 + index * 0.06}>
                      ...
                      >
                        ...
                        {/* Bottom */}
                        <div>
                          <h3 className="text-xl text-blue/80 font-semibold tracking-[-0.02em]">
                            {network.name}
                          </h3>

                          <p className="mt-3 max-w-xs text-xs leading-6 text-charcoal/50">
                            {network.description}
                          </p>
                ...
                <div className="relative border border-ivory/10 bg-ivory/[0.035] p-7 backdrop-blur-xl sm:p-9">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-8 space-y-3">
                      ...
                      >
                        <Mail size={17} className="text-blue-soft/70" />
        ...
        <section className="relative overflow-hidden bg-ivory">
          <div className="relative mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-36">
              <div className="flex flex-col justify-between gap-10 border-t border-charcoal/10 pt-8 sm:flex-row sm:items-end">
                <div>
                  <span className="text-[9px] text-blue/80 font-bold uppercase tracking-[0.28em]">
                    Keep exploring
                  </span>
                ...
                <Link
                  href="/resources"
                  className="group inline-flex shrink-0 items-center gap-3 border border-bronze/55 bg-bronze/[0.08] px-6 py-4 text-[10px] text-bronze font-bold uppercase tracking-[0.16em] transition-all duration-300 hover:border-bronze hover:bg-bronze hover:text-ivory hover:-translate-y-0.5 sm:px-7 sm:text-xs"
                >
                  Explore resources
