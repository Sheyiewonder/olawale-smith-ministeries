...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    async function loadDashboard() {
      try {
        const [adminResponse, resourceResponse] =
          await Promise.all([
            getCurrentAdmin(),
            getAdminResources(),
          ]);
  ...
  return (
    <main className="min-h-screen bg-ivory text-charcoal">
      ...
      <div className="mx-auto w-full max-w-[1600px] px-6 py-12 lg:px-10 lg:py-16">
        ...
        {/* Stats */}
        <div className="mt-12 grid gap-px overflow-hidden border border-charcoal/10 bg-charcoal/10 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard
