    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-24">
          ...
          <div>
            <div className="invite-reveal flex items-center gap-4">
            ...
            <h2 className="invite-reveal invite-delay-80 display-heading mt-7 max-w-4xl text-5xl leading-[0.94] tracking-[-0.04em] text-ivory sm:text-6xl lg:text-[6rem]">
              Invite Pastor
              <br />
          ...
          <div className="invite-reveal invite-delay-200 relative">
            ...
            <Link
              href="/invite"
              className="invite-reveal invite-delay-240 group relative mt-9 inline-flex items-center gap-4 border border-gold/50 px-6 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-gold transition-all duration-300 hover:-translate-y-0.5 hover:border-gold hover:bg-gold hover:text-charcoal sm:px-7 sm:text-xs"
            >
              <span>Invite</span>
