...
export default function ResourceCard({
  ...
  /*
   * PDF thumbnails are now generated by the backend when the PDF is
   * uploaded to Cloudinary.
   *
   * The URL is persisted as media.thumbnailUrl.
   *
   * Do NOT attempt to transform the PDF URL here.
   */
   ...
   * Priority:
   *
   * 1. Explicit resource-level thumbnail
   * 2. YouTube thumbnail
   * 3. PDF first-page thumbnail
   */
  const thumbnailUrl =
