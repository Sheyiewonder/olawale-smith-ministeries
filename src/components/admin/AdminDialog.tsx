      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-[2rem] border border-charcoal/10 bg-ivory shadow-2xl shadow-charcoal/20">
        ...
        <div className="p-7 sm:p-8">
          ...
          <button
            ...
            onClick={onCancel}
            disabled={loading}
            className="absolute right-5 top-5 flex h-9 w-9 items-center justify-center rounded-full text-charcoal/35 transition hover:bg-charcoal/5 hover:text-charcoal disabled:opacity-40"
            aria-label="Close"
          >
            <X size={17} />
          </button>
          ...
          <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            <button
              ...
              onClick={onCancel}
              disabled={loading}
              className="rounded-full border border-charcoal/10 px-5 py-3 text-[10px] font-semibold uppercase tracking-[0.14em] text-charcoal/60 transition hover:border-charcoal/20 hover:text-charcoal disabled:opacity-40"
            >
              {cancelLabel}
            </button>
