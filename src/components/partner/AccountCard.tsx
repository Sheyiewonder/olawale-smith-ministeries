...
export default function AccountCard({
  ...
  return (
    <div
      className={[
        "group relative overflow-hidden rounded-3xl border p-6 sm:p-7",
        "backdrop-blur-xl transition-all duration-500",
        isDollar
          ? "border-blue-deep/15 bg-blue-pale/70 hover:border-blue/30"
          : "border-bronze/20 bg-white/55 hover:border-gold/40",
      ].join(" ")}
    >
      {/* Atmospheric accent */}
      <div
            ...
            <button
              ...
              className={[
                ...
                copied
                  ...
                  : "border-charcoal/10 bg-white/50 text-charcoal/60 hover:border-gold/40 hover:bg-white hover:text-charcoal",
              ].join(" ")}
            >
              {copied ? (
